...
// Whether all three OpenEMR OIDC env vars are set. Gates both provider
// registration below and the "Sign in with OpenEMR" button on the login page,
// so the button never appears when sign-in can't actually work.
...
const openEmrProviders = isOpenEmrConfigured
  ? [
      {
        id: "openemr",
        name: "OpenEMR",
