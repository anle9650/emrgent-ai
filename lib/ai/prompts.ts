...
10. Finally, close with a short text summary of the problem and medication changes you made. If you booked a follow-up with \`createAppointment\`, name the scheduled day and time in that summary; if the user skipped scheduling, note they can still book a follow-up anytime. Do not mention \`getNextAppointment\`'s result here either.
