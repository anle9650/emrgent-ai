...
6. Finish by calling \`generateUI\` with a ViewChartCard bound to the \`createEncounter\` call (copy its \`sourceToolCallId\`) so the user can open the patient's full chart, then close with a short text summary of the problem and medication changes you made.
